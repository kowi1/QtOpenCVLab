...
QtOpenCVLAb combines the power of OpenCV's image processing library with the GUI sophistication of Qt to create an appealing end-user-application for car detection in a an image.
  ...
  Build Requirements:
   ...
   - MinGW was used for this project. Complete Pre-compiled binaries and SDK for OpenCV 2.4.13 built with forthe MinGW Compiler can downloaded at https://drive.google.com/open?id=1JXeEQ6K6JvjuNNBU_ZqynzNbwSsq9DCF.
